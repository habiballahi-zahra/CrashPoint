...
namespace GinjaGaming.FinalCharacterController
{
    public class PlayerAnimation : MonoBehaviour
    {
        ...
        private void UpdateAnimationState()
        {
            ...
            Vector2 inputTarget = isSprinting ? _playerLocomotionInput.MovementControls * _sprintMaxBlendValue :
                                  isRunBlendValue ? _playerLocomotionInput.MovementControls * _runMaxBlendValue : 
                                                    _playerLocomotionInput.MovementControls * _walkMaxBlendValue;
